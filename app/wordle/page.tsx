...
import WordleExample from '../components/WordleExample';
...
const Wordle = () => {
    ...
    return (
        <div className=" flex min-h-screen items-center justify-center bg-[#FFF5FE] bg-[url('/images/tex-1.jpg')] bg-blend-screen">
